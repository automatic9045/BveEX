...
namespace BveTypes.ClassWrappers
{
    ...
    public class NotchInfo : ClassWrapperBase
    {
        ...
        public int PowerNotchCount
        {
            ...
            set => PowerNotchCountSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public int HoldingSpeedNotchCount
        {
            ...
            set => HoldingSpeedNotchCountSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public int BrakeNotchCount
        {
            ...
            set => BrakeNotchCountSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public int B67Notch
        {
            ...
            set => B67NotchSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public int AtsCancelNotch
        {
            ...
            set => AtsCancelNotchSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public int MotorBrakeNotch
        {
            ...
            set => MotorBrakeNotchSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public bool HasHoldingSpeedBrake
        {
            ...
            set => HasHoldingSpeedBrakeSetMethod.Invoke(Src, new object[] { value });
        }
        ...
        public bool PrioritizeBrake
        {
            ...
            set => PrioritizeBrakeSetMethod.Invoke(Src, new object[] { value });
        }
    }
}
