...
namespace BveTypes.ClassWrappers
{
    ...
    public class PluginLoader : AtsPlugin
    {
        ...
        public PluginLoader(UserVehicleLocationManager locationManager, InputManager inputManager, HandleSet handles, HandleSet atsHandles, VehicleStateStore vehicleStateStore, SectionManager sectionManager, MapFunctionList beacons, DoorSet doors)
            : base(locationManager, inputManager, handles, atsHandles, vehicleStateStore, sectionManager, beacons, doors)
        {
        }
    }
}
