...
{
    /// <summary>
    /// <see cref="IExtensionSet.GetExtension{TExtension}"/> メソッドからこの BveEX 拡張機能のメインクラスを取得する時に使用する型を指定します。
    /// </summary>
    /// <seealso cref="HideExtensionMainAttribute"/>
    public class ExtensionMainDisplayTypeAttribute : Attribute
    {
        /// <summary>
        /// <see cref="IExtensionSet.GetExtension{TExtension}"/> メソッドからこの BveEX 拡張機能のメインクラスを取得する時に使用する型を取得します。
        /// </summary>
        ...
        /// </summary>
        /// <param name="displayType"><see cref="IExtensionSet.GetExtension{TExtension}"/> メソッドからこの BveEX 拡張機能のメインクラスを取得する時に使用する型。</param>
